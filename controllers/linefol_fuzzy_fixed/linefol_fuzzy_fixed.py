...
def run_robot(robot):
    ...
    rule7 = ctl.Rule(right_ir_a['putih'] & right_ir_b['hitam'] & mid_ir_a['hitam'] & mid_ir_b['hitam'] & mid_ir_c['hitam'] & left_ir_a['hitam'] & left_ir_b['hitam'], [rms['lambat'], lms['sedang']])
    rule8 = ctl.Rule(right_ir_a['putih'] & right_ir_b['putih'] & mid_ir_a['putih'] & mid_ir_b['putih'] & mid_ir_c['hitam'] & left_ir_a['hitam'] & left_ir_b['hitam'], [rms['lambat'], lms['cepat']])
    rule9 = ctl.Rule(right_ir_a['putih'] & right_ir_b['putih'] & mid_ir_a['putih'] & mid_ir_b['putih'] & mid_ir_c['putih'] & left_ir_a['hitam'] & left_ir_b['hitam'], [rms['lambat'], lms['cepat']])
    rule10 = ctl.Rule(right_ir_a['putih'] & right_ir_b['putih'] & mid_ir_a['putih'] & mid_ir_b['putih'] & mid_ir_c['putih'] & left_ir_a['putih'] & left_ir_b['hitam'], [rms['lambat'], lms['cepat']])
    ...
    rule14 = ctl.Rule(right_ir_a['hitam'] & right_ir_b['hitam'] & mid_ir_a['hitam'] & mid_ir_b['hitam'] & mid_ir_c['hitam'] & left_ir_a['putih'] & left_ir_b['putih'], [rms['lambat'], lms['cepat']])
    ...
    fuzzy_control = ctl.ControlSystem([rule1, rule2, rule3, rule4, rule5, rule6, rule7, rule8, rule9, rule10, rule11, rule12, rule13, rule14, rule15, rule16, rule17, rule18, rule19, rule20, rule21, rule22, rule23, rule24, rule25, rule26, rule27])
